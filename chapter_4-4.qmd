...
<<<<<<< HEAD
> For more details, please refer to Seeed Studio WiKi page: <br /> https://wiki.seeedstudio.com/xiao_esp32s3_getting_started/
=======
...
> Verify that `[Both NL & CR]` is selected on the Serial Monitor.
